...
# Export all symbols:
symbols = [_pad] + list(_punctuation) + list(_letters) + list(_letters_ipa) + list(_korean_ipa)
...
class FilePathDataset(torch.utils.data.Dataset):
    ...
    def _load_tensor(self, data):
        ...
        if not os.path.isfile(osp.join(self.root_path, wave_path)):
            print(f"{osp.join(self.root_path, wave_path)} 파일 경로 존재 안함")
            import sys
            sys.exit()
