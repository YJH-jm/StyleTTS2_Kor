...
# Google Drive API 설정
# Google Drive API 설정
SCOPES = ['https://www.googleapis.com/auth/drive.file']  # 파일 업로드 권한
...
@click.command()
@click.option('-p', '--config_path', default='Configs/config_ko.yml', type=str)
def main(config_path="Configs/config_ko.yml"):
    ...
    folder_id = "1ENs4y8xkAF4wlAFVyfObvkEXj5HEj3aR"
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if accelerator.is_main_process:
            ...
            if epoch % saving_epoch == 0:
                ...
                # google drive upload
                folder_id = "1ENs4y8xkAF4wlAFVyfObvkEXj5HEj3aR"
                upload_to_drive(save_path, folder_id)
                os.remove(save_path)
